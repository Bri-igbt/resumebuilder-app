    ...
    return (
        <div id="features" className="flex flex-col items-center scroll-mt-12">
            ...
            <Title
                ...
                description="Our streamlined process help you create a professional resume in minutes with intelligent AI-powered tools and features."
            />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                        <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                            <svg
                                ...
                                strokeLinejoin="round" className="size-6 stroke-violet-600"
                            >
