    ...
    return (
        <div className='relative'>
            <button
                ...
                className='flex items-center gap-1 text-sm text-purple-600 bg-gradient-to-br from-purple-50 to-purple-100 ring-purple-300 hover:ring transition-all rounded-lg py-2 px-3'
            >
                <Palette size={16} />
            ...
            { isOpen && (
                <div className='grid grid-cols-4 w-60 gap-2 absolute top-full left-0 right-0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
                    {colors.map((color) => (
                        <div className='relative cursor-pointer group flex flex-col'
                             key={color.value}
